 ...
 *
 */
package com.mservice.example.entity;

import java.util.Map;

/**
 * Storage Class representing the Hive Database in a rdbms
 *
 */
public class Database {
   ...
   */
  public Database(String name, String locationUri, String description,
